# Domain Invariants (Supporting Context)
...
- **Consent is King:** No external sharing occurs without the explicitly documented consent of the beneficiary (barring immediate life-saving exceptions).
