# 5 — Ground Truth Review Record: GT-L1-R1
...
| Field | Value |
|---|---|
| **Ontology element under review** | Facets Layer |
| **Ontology layer(s)** | L1 |
| **Ontology pillar(s)** | N/A |
| **Current structural position** | Dimensions/axes are provided, but lack evidenced values. |
