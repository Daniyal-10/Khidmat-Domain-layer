# 5 — Ground Truth Review Record: GT-PL7-R1
...
| Field | Value |
|---|---|
| **Ontology element under review** | VII — Resources & Support |
| **Ontology layer(s)** | Facets |
| **Ontology pillar(s)** | VII — Resources & Support |
| **Current structural position** | Tests the one facet structure with genuine external corroboration (Sector × Modality × Phase) against real practitioner language. |
