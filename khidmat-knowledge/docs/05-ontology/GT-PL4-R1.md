# 5 — Ground Truth Review Record: GT-PL4-R1
...
| Field | Value |
|---|---|
| **Ontology element under review** | Contradiction tolerance |
| **Ontology layer(s)** | Cognition |
| **Ontology pillar(s)** | IV — Epistemics & Knowledge |
| **Current structural position** | Disagreement between sources is recorded |
