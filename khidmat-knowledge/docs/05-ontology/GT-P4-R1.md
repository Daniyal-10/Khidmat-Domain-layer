# 5 — Ground Truth Review Record: GT-P4-R1
...
| Field | Value |
|---|---|
| **Ontology element under review** | Entity Primitive |
| **Ontology layer(s)** | Entities |
| **Ontology pillar(s)** | I — Human & Social Subject |
| **Current structural position** | "That which exists and persists as a distinct whole across encounters" |
