# 5 — Ground Truth Review Record: GT-L2-R1
...
| Field | Value |
|---|---|
| **Ontology element under review** | Entities Layer |
| **Ontology layer(s)** | L2 |
| **Ontology pillar(s)** | I — Human & Social Subject |
| **Current structural position** | Entities tracked (Person, Household, Family, Community, Organisation, Programme, Donor, Government body, Service provider, Emergent/mutual-aid group, Case) |
