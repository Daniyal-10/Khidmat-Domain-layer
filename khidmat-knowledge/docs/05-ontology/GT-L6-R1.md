# 5 — Ground Truth Review Record: GT-L6-R1
...
| Field | Value |
|---|---|
| **Ontology element under review** | Events Layer |
| **Ontology layer(s)** | L6 |
| **Ontology pillar(s)** | N/A |
| **Current structural position** | Case history constructed from sequence of events. |
