...
| GT-AR2 | CCR-6 — Non-linearity | How often does a case genuinely reopen or get sent back to an earlier stage, versus proceeding straight through? | NOT_ASSESSABLE |
...
| GT-AR6 | UHR-4 / CCR-5 — Algorithmic humility | When your system is unsure whether two records are the same person (or other algorithmic uncertainty), what happens next? | CONFIRMED |
