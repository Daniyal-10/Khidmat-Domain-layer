...
| GT-PL4 | IV — Epistemics & Knowledge | How does your organization currently record disagreement between two sources of information about the same person or household? | Directly targets GT-OQ13/contradiction representation. | NOT OBSERVED |
...
| GT-AR3 | CCR-7 — Dual-clock rule | Have you ever seen a person's life circumstances and their administrative status in your programme tracked as a single combined field, causing confusion? | NOT OBSERVED |
| GT-AR4 | CCR-5 — Human-oversight trigger | What kinds of decisions in your work always require a human sign-off, regardless of how confident an automated or junior assessment is? | NOT OBSERVED |
...
| GT-OQ13 | Q13 | Contradiction representation and handling | Epistemic humility supported; representation mechanism `[OPEN]` | Same as GT-PL4 above — when two sources disagree about the same fact, what actually happens to both pieces of information? | NOT OBSERVED |
