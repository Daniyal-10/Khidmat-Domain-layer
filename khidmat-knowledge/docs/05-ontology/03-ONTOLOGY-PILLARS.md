...
7. **Service Providers as Actors (RM §11.1):** Structurally modeled as active Entities (P4) capable of participating in coordination and making capacity decisions, while retaining a single-source evidence caveat (GT-OQ15). Governed provisional — single-source practitioner evidence acknowledged by Stage 7 G4; retained as a governance decision pending broader corroboration.
