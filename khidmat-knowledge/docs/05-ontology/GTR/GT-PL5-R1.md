# 5 — Ground Truth Review Record: GT-PL5-R1
...
| Field | Value |
|---|---|
| **Ontology element under review** | V — Actors & Ecosystem |
| **Ontology layer(s)** | Entities |
| **Ontology pillar(s)** | V — Actors & Ecosystem |
| **Current structural position** | Organisation and Programme collapsed into one Entity (P4) per Tier 1 authority (BL V1 §4). |
