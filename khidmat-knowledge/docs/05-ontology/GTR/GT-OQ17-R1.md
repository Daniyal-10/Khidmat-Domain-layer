# 5 — Ground Truth Review Record: GT-OQ17-R1
...
| Field | Value |
|---|---|
| **Ontology element under review** | Funder altitude |
| **Ontology layer(s)** | Coordination Pattern (L8) |
| **Ontology pillar(s)** | N/A |
| **Current structural position** | Genuinely open — Coordination Pattern (L8) |
| **Open question reference, if any** | GT-OQ17 / Q17 |
