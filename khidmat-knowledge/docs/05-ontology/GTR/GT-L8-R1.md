# 5 — Ground Truth Review Record: GT-L8-R1
...
| Field | Value |
|---|---|
| **Ontology element under review** | Coordination Patterns |
| **Ontology layer(s)** | Relation + Occurrence + Context + Norm |
| **Ontology pillar(s)** | N/A |
| **Current structural position** | Tests whether "Handoff," "Referral," "Reassessment loop," and "Grievance loop" match how these actually happen. |
