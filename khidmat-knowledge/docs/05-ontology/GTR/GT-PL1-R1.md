# 5 — Ground Truth Review Record: GT-PL1-R1
...
| Field | Value |
|---|---|
| **Ontology element under review** | Pillar I Boundary |
| **Ontology layer(s)** | Entities, Facets |
| **Ontology pillar(s)** | I — Human & Social Subject |
| **Current structural position** | Groups identity/capabilities separate from environment |
