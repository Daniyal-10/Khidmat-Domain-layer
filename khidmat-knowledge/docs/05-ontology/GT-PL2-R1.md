# 5 — Ground Truth Review Record: GT-PL2-R1
...
| Field | Value |
|---|---|
| **Ontology element under review** | II — Context & Environment |
| **Ontology layer(s)** | Context |
| **Ontology pillar(s)** | II — Context & Environment |
| **Current structural position** | Boundary establishing that environment/context alters the meaning of a household condition |
...
| Field | Value |
|---|---|
| **Humanitarian domain reality** | Environment and contextual variables dictate the urgency and relevance of household conditions. |
| **Organizational practice** | |
| **Local/contextual practice** | |
| **Ontology implication** | The ontology must structure context separately from conditions, allowing contextual variables to influence need determinations. |
