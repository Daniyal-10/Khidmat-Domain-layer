# 5 — Ground Truth Review Record: GT-OQ15-R1
...
| Field | Value |
|---|---|
| **Ontology element under review** | Service Providers as Actors |
| **Ontology layer(s)** | Entity (P4) vs. Context (P2) |
| **Ontology pillar(s)** | N/A |
| **Current structural position** | Genuinely open — Entity (P4) vs. Context (P2) |
| **Open question reference, if any** | GT-OQ15 / Q15 |
