# 5 — Ground Truth Review Record: GT-P3-R1
...
| Field | Value |
|---|---|
| **Ontology element under review** | Epistemic Stance Primitive |
| **Ontology layer(s)** | Cognition |
| **Ontology pillar(s)** | IV — Epistemics & Knowledge |
| **Current structural position** | "The warrant the system holds for what it asserts, including what it does not know" |
