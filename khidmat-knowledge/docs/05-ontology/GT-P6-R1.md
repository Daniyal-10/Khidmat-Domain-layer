# 5 — Ground Truth Review Record: GT-P6-R1
...
| Field | Value |
|---|---|
| **Ontology element under review** | Occurrence Primitive |
| **Ontology layer(s)** | Events |
| **Ontology pillar(s)** | N/A |
| **Current structural position** | "That which happened at a point in time" |
