# 5 — Ground Truth Review Record: GT-OQ4-R1
...
| Field | Value |
|---|---|
| **Ontology element under review** | Human-facet value sets |
| **Ontology layer(s)** | Facets, States |
| **Ontology pillar(s)** | N/A |
| **Current structural position** | Facets (L1) hold axes; States (L5) hold values; controlled vocabularies absent |
| **Open question reference, if any** | Q4 / GT-OQ4 |
...
| **Organizational practice** | Using programme-specific value sets alongside explicit markers for "unknown" or "not assessed," and falling back to text notes for complex reality. |
| **Local/contextual practice** | |
| **Ontology implication** | Value sets are contextual; epistemic states are required. |
