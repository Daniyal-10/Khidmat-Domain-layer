# 5 — Ground Truth Review Record: GT-AR5-R1
...
| Field | Value |
|---|---|
| **Ontology element under review** | CCR-8 — Dignity-as-constraint |
| **Ontology layer(s)** | Constraints / Architecture Rules |
| **Ontology pillar(s)** | I — Human & Social Subject |
| **Current structural position** | Architecture rule that dignity and safeguarding act as constraints (Norms) on practice, not merely numerical values. |
| **Open question reference, if any** | |
| **Upstream citation chain** | `04-ARCHITECTURE-RULES.md` (CCR-8) -> `05-GROUND-TRUTH-REVIEW-MATRIX.md` |
