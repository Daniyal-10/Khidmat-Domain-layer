...
reg_dir = "docs/02-discovery/registration-identity"
os.makedirs(reg_dir, exist_ok=True)

files = {}

files["README.md"] = """# Registration and Identity Domain Knowledge Base
This directory contains the modular Discovery Knowledge Base for the Registration and Identity domain.
"""

files["01-domain-overview.md"] = """# 1. Purpose, Outcomes, Capabilities, and Activities
...
files["01b-stakeholders.md"] = """# 2. Stakeholders
...
files["02-boundaries.md"] = """# 3. Domain Dependencies and Boundaries
...
files["03-concepts.md"] = """# 4. Business Concepts
...
files["04-relationships.md"] = """# 5. Business Relationships
...
files["04b-knowledge-patterns.md"] = """# 6. Knowledge Patterns
...
files["05-business-rules.md"] = """# 7. Policies and Constraints
...
files["05b-exceptions.md"] = """# 8. Exceptions
...
files["05c-business-tensions.md"] = """# 9. Business Tensions
...
files["07-business-lifecycles.md"] = """# 11. Business Lifecycles
...
files["08-decision-points.md"] = """# 12. Significant Business Decisions
...
files["09-information-requirements.md"] = """# 13. Information Requirements
...
files["10-open-questions.md"] = """# 14. Open Questions
...
files["11-evidence.md"] = """# 15. Discovery Evidence
...
files["12-domain-invariants.md"] = """# 16. Domain Invariants
...
files["13-business-language.md"] = """# 17. Terminology
...
files["14-ontology-readiness.md"] = """# 18. Ontology Readiness
...
files["STATUS.md"] = """# 19. Domain Completion Assessment
...
# 20. Compile the master REGISTRATION_IDENTITY_DISCOVERY.md
master_filepath = os.path.join(reg_dir, "REGISTRATION_IDENTITY_DISCOVERY.md")
with open(master_filepath, 'w', encoding='utf-8') as master:
    master.write("---\n")
    master.write("id: DOC-DISC-REGISTRATION_IDENTITY\n")
    master.write("title: REGISTRATION & IDENTITY DOMAIN DISCOVERY\n")
    master.write("version: 1.0\n")
    master.write("status: Draft\n")
    master.write("owner: Discovery\n")
    master.write("---\n\n")
    ...
    compile_order = [
        ...
        "03-concepts.md",
        "04-relationships.md",
        "04b-knowledge-patterns.md",
        "05-business-rules.md",
        "05b-exceptions.md",
        "05c-business-tensions.md",
        "06-business-events.md",
        "07-business-lifecycles.md",
        "08-decision-points.md",
        "09-information-requirements.md",
        "10-open-questions.md",
        "11-evidence.md",
        "12-domain-invariants.md",
        "13-business-language.md",
        "14-ontology-readiness.md",
        "STATUS.md"
    ]
    
    for filename in compile_order:
        filepath = os.path.join(reg_dir, filename)
        with open(filepath, 'r', encoding='utf-8') as f:
            master.write(f.read().strip() + '\n\n---\n\n')

print("Registration and Identity files created successfully, including compiled master discovery.")
